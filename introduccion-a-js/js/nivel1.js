...
/*function calcularAnios(anioActual, anioNacimiento){
    return anioActual - anioNacimiento;
}

const anioActual = Number(prompt("Introduzca el año actual "));
const anioNacimiento = Number(prompt("Introduzca el año de nacimiento "));
const edadUsuario = calcularAnios(anioActual, anioNacimiento)
...
function calcularSalarioSemanal(salarioMensual){
    return salarioMensual / 52;
}

function calcularSalarioDiario(salarioMensual){
    return salarioMensual / 365;
}

console.log("Tu salario anual es $" + calcularSalarioAnual(salarioMensual).toFixed(2));
console.log("Tu salario semanal es $" + calcularSalarioSemanal(salarioMensual).toFixed(2));
console.log("Tu salario diario es $" + calcularSalarioDiario(salarioMensual).toFixed(2));
*/
...
function imprimirResultado(operacion){
    //console.log("El resultado de " + numero1 + " " + operador + " " + numero2 + " es " + operacion);
    console.log(`El resultado de ${numero1} ${operador} ${numero2} es ${operacion}`);
}
...
if (operador === "+") {
    ...
    resultado = dividir(numero1, numero2).toFixed(4);
} else {
...
/*
//TAREA 1:
const nombreUsuario = prompt("Decime cual es tu nombre!") || false;
const miNombre = "Franco";
const nombreHermano = "Agustin";

if (nombreUsuario === miNombre) {
    console.log(`Hola Tocayo! Yo támbien me llamo ${nombreUsuario}`);
...
if (miEdad > edadUsuario) {
    console.log(`Yo soy más grande que vos.`);
...
*/
//TAREA 3:
const respuestaUsuario = (prompt("Tiene documento?") || "").toLocaleLowerCase();
let edadUsuario;


if (respuestaUsuario === "si") {
    edadUsuario = Number(prompt("Cuantos años ténes?"));
    if (edadUsuario > 18) {
